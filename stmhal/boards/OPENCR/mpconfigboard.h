...
#define MICROPY_HW_BOARD_NAME       "OPENCR"
...
#define MICROPY_BOARD_EARLY_INIT    OPENCR_board_early_init
void OPENCR_board_early_init(void);
...
// LEDs
#define MICROPY_HW_LED1             (pin_G12)
#define MICROPY_HW_LED2             (pin_E5)
#define MICROPY_HW_LED3             (pin_E4)
#define MICROPY_HW_LED4             (pin_G10)
